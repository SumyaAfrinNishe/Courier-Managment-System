...
<p><h3 style="color:DodgerBlue">Tracking Number:{{$collect->track_number}}</span></h3><h2><span style="color:#2874A6"></span><h2></p>
        ...
        <p class="card-text" ><b style="color:#2E4053;">Delivery Type:</b>{{$collect->delitype}}({{$collect->payment}})</p>
...
<p>
    <img style="border-radius: 4px;" width="200px;" src=" {{url('/uploads/'.$collect->cus_image)}}" alt="post">
</p>
