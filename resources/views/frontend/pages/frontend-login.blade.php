...
<html>
<head>
<link rel="stylesheet" type="text/css" href="{{url('frontend/frontendlogin/style.css')}}">
</head>
<body>
								...
								<div class="card-back">
                                    ...
                                    <form class="form-detail" action="{{route('registration.store')}}" method='POST'>
										...
										<div class="section text-center">
                                            ...
                                            <div class="form-group mt-2">
												<input type="number" name="contact" class="form-style" placeholder="Your Contact" id="contact" autocomplete="off">
												<i class="input-icon uil uil-lock-alt"></i>
											</div>
											<div class="form-group mt-2">
												<input type="password" name="logpass" class="form-style" placeholder="Your Password" id="logpass" autocomplete="off">
