	  ...
	  <div class="main">
		<div class="content-top">
			...
			<div class="close_but"><i class="close1"> </i></div>
				<ul id="flexiselDemo3">
				<li><img src="{{url('frontend/images/board1.jpg')}}" /></li>
				<li><img src="{{url('frontend/images/board2.jpg')}}" /></li>
				<li><img src="{{url('frontend/images/board3.jpg')}}" /></li>
				<li><img src="{{url('frontend/images/board4.jpg')}}" /></li>
				<li><img src="{{url('frontend/images/board5.jpg')}}" /></li>
			</ul>
			  ...
			  <div class="row">
				<div class="col-md-3 top_box">
				  <div class="view view-ninth"><a href="single.html">
                    <img src="{{url('frontend/images/1.jpg')}}" class="img-responsive" alt=""/>
                ...
                <div class="col-md-3 top_box">
					<div class="view view-ninth"><a href="single.html">
                    <img src="{{url('frontend/images/2.jpg')}}" class="img-responsive" alt=""/>
                    <div class="mask mask-1"> </div>
                    <div class="mask mask-2"> </div>
                      <div class="content">
                        <h2>Hover Style #9</h2>
				...
				<div class="col-md-3 top_box">
					<div class="view view-ninth"><a href="single.html">
                    <img src="{{url('frontend/images/3.jpg')}}" class="img-responsive" alt=""/>
                    <div class="mask mask-1"> </div>
                    <div class="mask mask-2"> </div>
                      <div class="content">
                        <h2>Hover Style #9</h2>
				...
				<div class="col-md-3 top_box1">
					<div class="view view-ninth"><a href="single.html">
                    <img src="{{url('frontend/images/4.jpg')}}" class="img-responsive" alt=""/>
                    <div class="mask mask-1"> </div>
                    <div class="mask mask-2"> </div>
                      <div class="content">
                        <h2>Hover Style #9</h2>
